  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-start lg:gap-12">
      ...
      >
        ...
        <motion.h1
          variants={fadeUp}
          className="mt-5 text-5xl font-semibold tracking-[-0.06em] text-white md:text-7xl"
        >
          {project.title}
        </motion.h1>
        <motion.p
          variants={fadeUp}
          className="mt-5 max-w-xl text-lg leading-8 text-[var(--color-muted)] md:text-xl"
        >
          {project.description}
        </motion.p>
...
export default function ProjectPage({
  ...
  return (
    <>
      <Navbar />
      <main className="container-shell pb-14 pt-28 md:pb-20 md:pt-36">
